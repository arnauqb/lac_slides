...
[arnau.ai/diff_abms_tutorial](www.arnau.ai/diff_abms_tutorial)
...
![](./lac_images/blackbirds.png){width=600 fig-align=center}
...
vi = VI(loss, posterior_estimator, prior,
    gradient_estimation_method="pathwise", diff_mode="reverse")
vi.run(true_data)
```
