...
![](https://github.com/arnauqb/blackbirds/blob/main/docs/_static/banner.png?raw=true){width=600 fig-align=center}
...
![](./lac_images/predictions.gif){height=400 .absolute top=350 left=0}


![](./lac_images/posteriors.gif){width=900 .absolute top=0 right=-100}
...
![](./lac_images/posteriors.gif){width=800 .absolute top=0 right=0}
...
<center> Find the slides and references at [arnau.ai/lac](www.arnau.ai/lac)</center>